        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center">
              ...
              <span className="ml-2 text-lg font-medium">Brand</span>
            </Link>
            <p className="text-sm text-gray-500">Simple, clean, and modern design for your digital products.</p>
          </div>
          ...
          <div className="space-y-4 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-sm text-gray-500">Get the latest updates and news delivered to your inbox.</p>
